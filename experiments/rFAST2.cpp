...
// Cheap reduce for x < 2^96 (all linear-layer accumulators qualify: <= 12*2^64).
// hi fits in 32 bits, so the 2^96 term and its borrow branch vanish: 2 conditionals, not 3.
