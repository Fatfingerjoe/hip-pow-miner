...
// Single-conditional reduce for x < 2^96. Every reduce site OUTSIDE gf_mul is bounded by
// 12*2^64 (worst measured hi = 7 vs the 2^32 limit -- ft3.cpp), so the high-half term and its
// borrow branch are provably dead there. Validated congruent mod P over 915 adversarial cases.
